                    ...
                    <table class="table table-dark">
                        ...
                        <tbody>
                            @foreach($posts as $news)
                                <tr>
                                    <th>{{ $news->id }}</th>
                                    <td>{{ \Illuminate\Support\Str::limit($news->name, 20) }}</td>
                                    <td>{{ \Illuminate\Support\Str::limit($news->gender, 5) }}</td>
                                    <td>{{ \Illuminate\Support\Str::limit($news->hobby, 20) }}</td>
                                    <td>{{ \Illuminate\Support\Str::limit($news->introduction, 20) }}</td>
                                    <td>
                                        <div>
